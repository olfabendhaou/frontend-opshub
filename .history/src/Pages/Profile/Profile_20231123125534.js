...
const Profile = ({ setAuth }) => { 
  ...
  const fetchProfileData = async () => {
          ...
          const handleSaveProfile = async () => {
            ...
            const showToastMessagesuccess = (e,message) => {
              e.preventDefault();
          ...
          const config = {
              ...
              showToastMessagesuccess(message)
              // setIsEditing(false);
              console.log (message)
            } catch (error) {
...
<div className='Div'>
      ...
      <Button variant="contained" onClick={errorMessage? showToastMessage :showToastMessagesuccess && handleSaveProfile} >Save</Button>
