...
onChange={handleInputChange&&handleCountryChange}
>
{
...
onChange={handleInputChange&&handleLanguageChange}
>
{languages.map((lang) => (
  <MenuItem key={lang} value={lang} onClick={handleLanguageChange}>
...
onChange={handleInputChange&&handleTimezoneChange}
>
{timezones.map((tz) => (
