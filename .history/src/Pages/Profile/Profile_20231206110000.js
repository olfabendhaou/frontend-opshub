...
<div className='Div'>
<label style={{display:'flex', justifyContent:'flex-start', marginLeft:"200px"}} >Country: </label>
<Select
style={{width: '213px', height:'33px', marginRight:'54px',display:'flex', justifyContent:'flex-start'}}
name="country"
value={user.country}
