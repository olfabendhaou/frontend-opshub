...
<Select
style={{width: '200px', height:'30px',position:'absolute', justifyItems:'flex-end', marginLeft:'160px',textAlign: 'left' }}
name="country"
...
>
{
  countryArr.map(({label,value})=>(
    <MenuItem sx={{typography: 'body2', fontSize: 'default' }} key={value} value={value}>{label}</MenuItem>
  ))}
</Select>
</div>
<div className='Div'>
