...
<div className='Div'>
      ...
      <Stack spacing={2} direction="row">
          <div className='text-center text-md-start mt-4 pt-2'>
            <MDBBtn className="mb-0 px-5" size='lg' onClick={errorMessage? showToastMessage : handleSaveProfile}>Save</MDBBtn>
          </div>
          <div className='text-center text-md-start mt-4 pt-2'>
          <MDBBtn className="mb-0 px-5" size='lg' onClick={()=>{navigate('/editpassword')}}>Edit Password<</MDBBtn>
        </div>
       <Button variant="contained" onClick={errorMessage? showToastMessage : handleSaveProfile} >Edit Password</Button>
