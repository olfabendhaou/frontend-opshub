...
<Select
style={{width: '200px', height:'33px',position:'absolute', justifyItems:'flex-end', marginLeft:'160px'}}
name="country"
...
>
{
  countryArr.map(({label,value})=>(
    <MenuItem key={value} value={value} onClick={handleCountryClick}>{label}</MenuItem>
  ))}
</Select>
</div>
<div className='Div'>
...
>
{languages.map((lang) => (
  <MenuItem key={lang} value={lang} onClick={handleLanguageClick}
  >
...
<Select
style={{width: '200px', height:'33px',position:'absolute', justifyItems:'flex-end', marginLeft:'160px' ,marginBottom:'2px'}}
name="timezone" 
value={selectedTimeZone}
onChange={handleInputChange}
>
{timezones.map((tz) => (
  <MenuItem  key={tz} value={tz} onClick={handleTimezoneClick}>
    {tz}
  </MenuItem>
))}
</Select>
