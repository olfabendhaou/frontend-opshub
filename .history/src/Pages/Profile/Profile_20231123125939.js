...
const Profile = ({ setAuth }) => { 
  ...
  const fetchProfileData = async () => {
        ...
        const showToastMessagesuccess = (e) => {
          e.preventDefault();
...
<div className='Div'>
      ...
      <Button variant="contained" onClick={errorMessage? showToastMessage : message? handleSaveProfile && showToastMessagesuccess} >Save</Button>
