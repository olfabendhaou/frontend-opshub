...
export default function Integration() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:8000/api/instance/system2-instances/${connected_system_id_2}`,config)
      .then((response) => {
...
////////////////////Create integration////////////////////
  const handleSubmit = (event) => {
    ...
    axios
      .post('http://localhost:8000/api/integration/create', integrationData,config)
      .then((response) => {
